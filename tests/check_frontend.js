...
assert(script.includes("apiFetch(\"/api/settings\""));
assert(script.includes("openSettingsModal"));
...
assert(html.includes("data-open-settings"));
assert(html.includes("data-settings-modal"));
